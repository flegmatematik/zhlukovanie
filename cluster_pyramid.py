...
tazisko_distance_from_base = taznica_length*(1/3)
tazisko_distance_from_top = taznica_length*(2/3)
taznica_length_from_center = sqrt(pow(cell_radius*2 + gap_size ,2) - pow(tazisko_distance_from_top,2))
