...
# cylinder A
tmp_shape = shapes.Cylinder(center=[boxX/2, boxY/2, boxZ/2], axis=[0.0, 0.0, 1.0], length=boxZ, radius=6.0, direction=1)
boundaries.append(tmp_shape)
...
# distance_from_taznica = sqrt(pow(cell_radius*2,2) - pow(cell_radius,2))
taznica_length = sqrt(pow(cell_radius*2 + gap_size ,2) - pow(cell_radius + gap_size/2.0 ,2))
...
"""
cell_positions.append([cell_radius + 0.5,
                       boxY/2.0,
                       boxZ/2.0])
cell_positions.append([3*cell_radius + 2*0.5,
                       boxY/2.0,
                       boxZ/2.0])
cell_positions.append([5*cell_radius + 2*0.5,
                       boxY/2.0,
                       boxZ/2.0])
cell_positions.append([7*cell_radius + 2*0.5,
                       boxY/2.0,
                       boxZ/2.0])
"""
